    ...
    public static IEndpointRouteBuilder MapProjectEndpoints(this IEndpointRouteBuilder app)
    {
        app.MapPost("/projects", async (CreateProjectRequest request, MomosDbContext db, CancellationToken cancellationToken) =>
        {
            ...
            var project = new Project
            {
                ...
                AppInstallerUri = hasInstallerUri ? request.AppInstallerUri : null,
                AppInstallPlatform = hasPlatform ? request.AppInstallPlatform : null,
                AppInstallArgs = request.AppInstallArgs,
                AppInstallLaunchCommand = hasLaunchCommand ? request.AppInstallLaunchCommand : null,
